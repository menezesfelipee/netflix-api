...
let ParticipantsController = class ParticipantsController {
    ...
    async create(createParticipant) {
        return this.participantsService.create(createParticipant);
    }
    async update(updateParticipant, id) {
...
], ParticipantsController.prototype, "listAll", null);
__decorate([
    (0, common_1.Get)('/:id'),
    (0, common_1.UsePipes)(common_1.ValidationPipe),
    ...
    __metadata("design:returntype", Promise)
], ParticipantsController.prototype, "showOne", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_participant_dto_1.CreateParticipantDto, Number]),
    __metadata("design:returntype", Promise)
